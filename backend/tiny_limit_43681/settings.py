"""
Django settings for tiny_limit_43681 project.
...
ROOT_URLCONF = 'tiny_limit_43681.urls'
...
WSGI_APPLICATION = 'tiny_limit_43681.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tiny_limit_43681 API",
    "DESCRIPTION": "API documentation for tiny_limit_43681 App",
    "VERSION": "v1",
}
